...
with DAG('databricks_example_dag',
    ...
    hook_actions = DummyOperator(task_id="hook_actions")
    hook_action_tasks = [
        python_run_now,
        python_submit_run,
        python_get_run_page_url,
        python_get_job_id,
        python_get_run_state,
        python_cancel_run,
        python_start_cluster,
        python_restart_cluster,
        python_terminate_cluster,
        python_install,
        python_uninstall
    ]
    databricks_operators = DummyOperator(task_id="databricks_operators")
    databricks_operator_tasks = [opr_run_now, opr_submit_run]

    start >> databricks_operators >> databricks_operator_tasks >> finish
    start >> hook_actions >> hook_action_tasks >> finish
